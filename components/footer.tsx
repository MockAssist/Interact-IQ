...
export const Footer = () => {
  return (
    <footer className="bg-blue-0 static">
      <div className="max-w-7xl mx-auto py-12 overflow-hidden px-8">
        <nav
        ...
        >
          ...
          <a href="https://github.com/Vancelott" className="flex">
            <svg
              className="fill-gray-300 hover:fill-gray-500 hover:cursor-pointer transition-colors delay-75"
